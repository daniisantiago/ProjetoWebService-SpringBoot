...
@Configuration
@Profile("test") // tem que ser o mesmo nome dado no spring.profiles.active=test do
					// application.properties
public class TestConfig implements CommandLineRunner {

	/*
	 * uso do @Autowired : o proprio Spring na hora que estiver rodando a aplicação
	 * vai resolver essa dependencia e associar uma instacia de UserRepository
	 * dentro do userRepository
	 */
	@Autowired
...
>>>>>>> 2606e79ec6eb800ff1db806e3bf82c3da408263f
	}
